...
class RegisterModelForm(forms.ModelForm):
    ...
    password = forms.CharField(label='密码',required = True,widget=forms.PasswordInput(),error_messages={'required':'密码不能为空。'})
    confirm_password = forms.CharField(label='重复密码',required = True,widget=forms.PasswordInput(),error_messages={'required':'请输入重复密码。'})
    code = forms.CharField(label='验证码',required = True,error_messages={'required':'验证码不能为空。'})
    class Meta:
